...
export default function Sidebar(props: SidebarProps) {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <div
        className={`fixed top-0 right-0 h-full w-80 bg-[var(--primary-background)] text-[var(--primary-text-color)] shadow-lg z-60 transform transition-transform duration-300 ${
