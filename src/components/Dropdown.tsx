...
export default function Dropdown(props: DropdownProps) {
  ...
  return (
    <div className="relative w-full" ref={dropdownRef}>
      ...
      {/* เมนู Dropdown */}
      {isOpen && (
        <div className="absolute z-10 mt-1 w-full bg-[var(--primary-input-background-color)] border-2 border-[var(--primary-border-color)] rounded-lg shadow-lg overflow-hidden">
